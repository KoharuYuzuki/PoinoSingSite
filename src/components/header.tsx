...
export default defineComponent({
  ...
  render() {
    return (
      ...
      >
        <div class="h-12 m-4 rounded-2xl bg-theme flex justify-between items-center">
          <div class="flex items-center">
            <div class="w-12 h-12 bg-main [mask-image:url(./assets/icon.svg)]"></div>
            <Link underline={ false } href="./">
              {() => <p class="text-lg">PoinoSing Official Site</p>}
            </Link>
          </div>
          ...
          <dialog
            ref="sideMenuDialog"
            class={`
              w-72 h-fit max-h-[calc(100dvh-10rem)] m-auto mt-4 rounded-2xl bg-theme
            ...
            >
              <div class="flex flex-col gap-2 grow overflow-y-scroll overscroll-contain scrollbar-light">
                ...
                <div class="flex flex-col gap-2">
                  ...
                  <Link newTab={ true } underline={ false } href="https://github.com/KoharuYuzuki/PoinoSing">
                    {() => <p>GitHub</p>}
                  </Link>
